...
public class Util {
    ...
    private static Material[] horse_armors = {Material.IRON_BARDING, Material.GOLD_BARDING, Material.DIAMOND_BARDING};
    ...
    public static boolean isDurable(ItemStack stack) {
        if (isTool(stack) || isArmor(stack) || isSword(stack) || isHorseArmor(stack) || isTool(stack) || isBow(stack)) {
            return true;
        } else {
            return false;
        }
