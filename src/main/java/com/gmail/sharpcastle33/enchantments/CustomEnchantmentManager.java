...
public class CustomEnchantmentManager {
    ...
    public static Map<CustomEnchantment, Integer> getEnchantmentTable(ItemStack stack) {
        ...
        if (Util.isSword(stack)) {
            ...
            ret.put(CustomEnchantment.KNIGHT, 1);
        ...
        if (Util.isHorseArmor(stack)) {
            ret.put(CustomEnchantment.VALIANT, 1);
            ret.put(CustomEnchantment.CHARGE, 1);
            ret.put(CustomEnchantment.HORSE_ARCHERY, 1);
            ret.put(CustomEnchantment.WARHORSE, 1);
        }
    ...
    /**
     * Returns a list of CustomEnchantments containing all vanilla enchantments
     * on an item.
     *
     * @param stack
     * @return
