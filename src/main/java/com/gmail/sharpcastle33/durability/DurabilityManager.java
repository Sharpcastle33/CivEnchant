...
public class DurabilityManager {
    ...
    /**
     * String getCustomDurability(ItemStack item) returns the String containing
     * the CustomDurability
     */
    ...
    /**
     * List<Integer> getDurability(String lore) returns the current and maximum
     * durability Lore: Durability: 23/42 dur[0] = 23 = dur[CURRENT_DURABILITY]
    ...
    /**
     * void setNewDurability(ItemStack item, int cur, int max) updates the
     * durability in the lore item cannot be broken with this method updates the
